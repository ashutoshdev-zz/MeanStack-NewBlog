...
//    });
    ...
    router.get('/sitemaps/:name', function(req, res) {       
     console.log(req.params.name);
     var name=req.params.name;
      var thenum = name.match(/[0-9]+/g);
        console.log(thenum);
        var skto=thenum+'000';
        var add=1000;
        var lmt=Number(skto) + Number(add);  
        console.log(skto);
        console.log(lmt);
     if(name=="sitemap.xml"){
        ...
        Post.find({}, 'paramal', function(err, mongourls)
        {
            ...
            var sitemap = sm.createSitemap({
                hostname: 'https://www.futureworktechnologies.com',
...
//            
        }).skip(Number(skto)).limit(Number(lmt));
    }
    });
            ...
            Post.findOne({'paramal': main_url[2]}, function(err, post) {
                if (post) {
                   // console.log(post.paramal);
                    ...
                    metaTags.metaTagsUrl =  'https://www.futureworktechnologies.com/'+post.paramal;
